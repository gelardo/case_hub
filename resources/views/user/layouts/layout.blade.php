...
<script>
    ...
    user = {
        showSwal: function(type) {
            ...
            if (type == 'delete') {
                Swal.fire({
                    title: 'You are not allowed to delete. Please contact Admin',
                    customClass: {
            ...
            else if (type == 'change-lawyer') {
                Swal.fire({
                    title: 'Enter Lawyer Name',
                    input: 'text',
                    inputAttributes: {
                        autocapitalize: 'off'
                    },
